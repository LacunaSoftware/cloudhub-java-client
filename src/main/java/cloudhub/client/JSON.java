...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new cloudhub.client.model.GetServiceAvailabilityResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new cloudhub.client.model.TrustServiceAuthParametersModel.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new cloudhub.client.model.TrustServiceInfoModel.CustomTypeAdapterFactory());
